...
parser.add_argument(
    '-t', '--token', help='Loggly API Token (username/password will be ignored if provided)')
...
# launch search
getSearch(*API_request + API_dates + API_output + API_credentials, token=args.token)
